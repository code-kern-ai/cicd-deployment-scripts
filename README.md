...
- [ACR: Delete Docker Image](#acr:-delete-docker-image)
...
- [GitHub: Workflow Wait](#github:-workflow-wait)
- [K8: Apply](#k8:-apply)
- [K8: Database Downgrade](#k8:-database-downgrade)
- [K8: Database Upgrade](#k8:-database-upgrade)
- [K8: Cluster Deploy](#k8:-cluster-deploy)
- [K8: Destroy](#k8:-destroy)
- [K8: Edit](#k8:-edit)
- [K8: Execution Environments](#k8:-execution-environments)
- [K8: Inference Reload Config](#k8:-inference-reload-config)
